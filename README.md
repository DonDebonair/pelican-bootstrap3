...
### pelican-flickr Plugin

Install the plugin using the instructions supplied at [here](https://github.com/La0/pelican-flickr)

Add the following settings to your `pelicnconf.py` file:

```
PLUGIN_PATHS = ["plugins"]
PLUGINS = ['pelican-flickr2', ]

FLICKR_API_KEY = 'YOUR API KEY'
FLICKR_USER = 'YOUR FLICKR USER'

# Create a page menu item for the Flickr set index page
MENUITEMS = (
                ('Photos', '/flickr/index.html'),
            )

# custom page generated with a jinja2 template
# This is required to build the Flickr set index page linked above
